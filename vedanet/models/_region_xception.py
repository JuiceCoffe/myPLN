...
__all__ = ['RegionXception']


class RegionXception(YoloABC):
    def __init__(self, num_classes=20, weights_file=None, input_channels=3,
        ...
        self.backbone = backbone.Xception()
        self.head = head.RegionXception(num_anchors=len(anchors_mask[0]), num_classes=num_classes)
