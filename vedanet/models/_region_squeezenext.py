...
__all__ = ['RegionSqueezenext']


class RegionSqueezenext(YoloABC):
    def __init__(self, num_classes=20, weights_file=None, input_channels=3,
        ...
        self.backbone = backbone.Squeezenext()
        self.head = head.RegionSqueezenext(num_anchors=len(anchors_mask[0]), num_classes=num_classes)
