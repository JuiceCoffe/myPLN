...
__all__ = ['RegionMobilenet']


class RegionMobilenet(YoloABC):
    def __init__(self, num_classes=20, weights_file=None, input_channels=3,
        ...
        self.backbone = backbone.Mobilenet()
        self.head = head.RegionMobilenet(num_anchors=len(anchors_mask[0]), num_classes=num_classes)
