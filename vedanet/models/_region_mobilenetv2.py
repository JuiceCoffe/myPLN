...
__all__ = ['RegionMobilenetv2']


class RegionMobilenetv2(YoloABC):
    def __init__(self, num_classes=20, weights_file=None,
        ...
        self.head = head.RegionMobilenetv2(num_anchors=len(anchors_mask[0]), num_classes=num_classes)
    ...
    def modules_recurse(self, mod=None):
        ...
        for module in mod.children():
            if isinstance(module, (nn.ModuleList, nn.Sequential, backbone.Mobilenetv2, head.RegionMobilenetv2)):
